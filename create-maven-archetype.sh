...
sed -i -e "s/spring-boot-gae-blank/projectName/g" pom.xml
sed -i -e "s/github\.com\/making\/projectName/github.com\/making\/spring-boot-gae-blank/g" pom.xml
...
sed -i -e "s/projectName/spring-boot-gae-blank/g" pom.xml
